...
function DashboardTab() {
  ...
  const { mode, product ,edithandle, updateProduct,deletProducts , Order ,user} = context;
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className="relative overflow-x-auto ">
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                    ...
                    const {title,price,imgUrl,description,category,date} = item;
                    return (
                          ...
                          <td className="px-6 py-4">
                            <div className=" flex gap-2">
                              <div
                                ...
                                style={{ color: mode === "dark" ? "white" : "" }}
                              >
                                <div onClick={()=>deletProducts(item)}>
                                  <svg
              ...
              <div className="relative overflow-x-auto mb-16">
                ...
                </h1>
                {
                  ...
                  {allorder.cartItems.map((item)=>{
                    const {imgUrl,price,title,category} = item
