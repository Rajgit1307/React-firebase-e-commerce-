...
import { deletFromCart } from "../../redux/CartSlice";
...
function Cart() {
  ...
  // ***************useState for taking the user's address*************
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_dSDHe0t4Pbyvbz",
      key_secret: "KtUcPs9bFbgSQDQytc7UsonI",
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 ">
            {cartItems.map((item, index) => {
              const { title, price, imgUrl, description ,id } = item;
